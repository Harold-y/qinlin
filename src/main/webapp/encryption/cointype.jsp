        ...
        <div id="main" style="margin-top: 5rem; margin-bottom: 5rem">
            ...
            <div id="marketCoinTypeDiv" class="container">
                <table class="layui-table" lay-skin="line">
                    ...
                    <tbody id="coinTbody">
                        <tr v-for="item in listData" height='80px'>
                            <td>
                                <a :href="'/encryption/coindetail.jsp?coinid='+item.coinid+''">
                                    <div class="row">
                                        <div class="col-sm-1"><input type='hidden' :value="item.coinid"></div>
                                        <div class="col-sm-1"><img :src="item.url" style="height: 30px; border-radius: 10px"></div>
                                        <div class="col-sm-2" style="font-size: 25px" v-text="item.abbre_name"></div>
                                        <div class="col-sm-2" style="color: #5c636a; opacity: 0.7" v-text="item.cn_name"></div>
                                        <div class="col-sm-2" v-text="item.eng_name"></div>
                                    </div>
                                </a>
                            </td>
                            <td >$ {{item.Price}}</td>
                            <td v-bind:class="item.colorStyle">{{item.Variation}}%</td>
                            <td><button class='btn btn-outline-primary' @click="getDetail(item.coinid)">交易</button></td>
                        </tr>
                    </tbody>
                </table>
                <%--<div class="row">
