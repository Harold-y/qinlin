...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid" id="headerInnerDiv">
                ...
                <div class="col-sm-3" style="margin-left: 10rem">
                    ...
                    <a href="usercenter.jsp" target="_blank"><button type="button" class="btn btn-outline-primary" v-show="alreadyLogin">个人中心</button></a>
    ...
    <div id="main" style="margin-top:50px">
        <div class="container">
            <div class="row">
                <h1>选择琴麟货币交易所，因为专业</h1>
            </div>
            <div class="row" style="margin-top:20px">
                <img src="/static/img/wall1.jpg" class="img-fluid" alt="...">
            </div>
            <div class="row" style="margin-top:20px; margin-bottom: 5rem;">
...
<script>
    var app3 = new Vue({
        ...
        methods:{
            ...
            {
                $.ajax({
                    url:"https://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=IBM&interval=5min&apikey=41ZKJAGWRQF5844Z",
                    method:"get",
                    success:function (index) {
                        console.log(index)
                    }
