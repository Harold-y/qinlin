...
<div id="main" style="background-image: url('/static/img/background/wallhaven-rd3xvm.jpg')">
    ...
    <div class="container">
        ...
        <button class="btn btn-primary" id="registerButton" style="margin-bottom:50px">Submit</button>
    </div>
