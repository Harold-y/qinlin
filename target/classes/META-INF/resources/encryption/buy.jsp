...
<div class="container-fluid" style="background-color: white" id="generalDiv">
    ...
    <div class="row" style="margin-top:20px">
        <div class="col-sm-10">
            <span style="font-size: 10px; opacity: 0.65">我要支付</span>
            <div class="input-group mb-3">
                ...
                <button class="btn btn-outline-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false" >支付币种</button>
    ...
    <div class="row">
        <div class="col-sm-10">
            <span style="font-size: 10px; opacity: 0.65">我将收到</span>
            <div class="input-group mb-3">
    ...
    <div class="row">
        <div class="col-sm-10">
            <span style="font-size: 10px; opacity: 0.65">支付方式</span>
            <div class="input-group mb-3">
                ...
                <label class="input-group-text" for="inputGroupSelect02">支付方式</label>
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row" style="margin-top:20px">
        <button class="btn btn-primary" @click="buy">购入</button>
    </div>
</div>
</body>
<script>
     ...
     methods:{
         ...
         buy:function()
         {
            ...
            if(app1.coinAmount <= 0 || app1.currencyAmount<=0)
            {
             ...
             $.ajax({
                 url:"/bankAccountController/transferOut",
                 method:"post",
                 data:{
                     "userid": app1.userid,
                     "bankid": app1.bankid,
                 ...
                 success:function(result)
                 {
                     ...
                     {
                         $.ajax({
                             url:"/capitalAccountController/transferIn",
                             method:"post",
                             data:{
                                 "userid": app1.userid,
                                 "coinid": app1.coinid,
